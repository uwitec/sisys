		...
		<div id="sidebar">
			<div id="sidebar-wrapper">
				...
				<li>
					...
					<li><a href="OutOfDue.jsp" class="nav-top-item no-submenu">
					...
					<div id="login-content">
						...
						<form action="SheetProduct.jsp">
							<p>
								<label>表格类型</label> <select name="time" id="time"
									...
									<option value="SearchProduct_admin.jsp">产品废品统计表</option>
									<option value="SearchProduct2_admin.jsp">批次某产品废品统计表</option>
									<option value="SearchProduct3_admin.jsp">员工废品统计表</option>
									<option value="SearchProduct4_admin.jsp">部门废品统计表</option>
									<option value="SearchProduct5_admin.jsp">生产线废品统计表</option>
								</select>
							</p>

							<p>
								<label>部门</label> <input class="text-input" type="text" />
							</p>
							<div class="clear"></div>
							<p>
						...
						<div>
							<input class="button" type="submit" value="确定"
								onclick="window.open('SheetProduct1-4.jsp')" />
						</div>
					</div>
					<!-- End #login-content -->
				</div>
