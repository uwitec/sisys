					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<table class = "">
							<tr>
								...
								<td><span>张三</span></td>
								<td><span>工号</span></td>
								<td><span>280012083</span></td>
								<td><span>所属生产线</span></td>
								<td><span>20120623111</span></td>
							</tr>
							<tr>
								<td><span>产品名称</span></td>
								<td><span>B21转轴</span></td>
								<td><span>批次号</span></td>
								<td><span>20120623233</span></td>
							...
							<tr>
								<td><a href="FormAlter.jsp" class="button">修改</a></td>
								<td><a href="FormSearch_admin.jsp" class="button">删除</a></td>
							</tr>
						</table>
