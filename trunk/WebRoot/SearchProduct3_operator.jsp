					...
					<div id="login-content">
						...
						<form action="SheetProduct.jsp">
							<p>
								<label>表格类型</label> <select name="time" id="time"
									...
									<option value="SearchProduct_operator.jsp">产品废品统计表</option>
									<option value="SearchProduct2_operator.jsp">批次某产品废品统计表</option>
									<option value="SearchProduct3_operator.jsp">员工废品统计表</option>
									<option value="SearchProduct4_operator.jsp">部门废品统计表</option>
									<option value="SearchProduct5_operator.jsp">生产线废品统计表</option>
								</select>
							</p>
						...
						<div>
							<input class="button" type="submit" value="确定"
								onclick="window.open('SheetProduct1-3.jsp')" />
						</div>
					</div>
					<!-- End #login-content -->
				</div>
