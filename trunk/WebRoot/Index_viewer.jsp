	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					<a href="Index_viewer.html" class="nav-top-item current no-submenu"> <!-- Add the class "current" to current menu item -->
						首页
					</a>       
				</li>
				...
				<li> 
					...
					<ul>
						<li><a href="FormSearch_viewer.html">工单列表</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li><a href="SearchJD_viewer.html">生产进度统计单</a></li>
						<li><a href="SearchHour_viewer.html">工时统计单</a></li>
						<li><a href="SearchProduct_viewer.html">不合格品统计单</a></li>
						<li><a href="SearchPeople_viewer.html">员工工作统计单</a></li>
					</ul>
				</li>
				
				<li>
					<a href="AdminInfo_viewer.html" class="nav-top-item no-submenu"> <!-- Add the class "no-submenu" to menu items with no sub menu -->
						个人信息管理
					</a>
				</li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="FormSearch_viewer.html"><span>
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<table>
							...
							<tbody>
								...
								<tr>
									<td><h6>product6:</h6><a href="SheetJD1.html" title="title">20120624</a></td>
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<table>
							...
							<tbody>
								...
								<tr>
									<td><h6>product6:</h6><a href="SheetJD1.html" title="title">20120501</a></td>
