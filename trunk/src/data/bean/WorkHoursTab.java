...
public class WorkHoursTab {
	...
	public double getWorkHours() {
		return new BigDecimal(workHours).setScale(2,BigDecimal.ROUND_HALF_UP).doubleValue();
	}
	...
	public double getSalary() {
		return new BigDecimal(salary).setScale(2,BigDecimal.ROUND_HALF_UP).doubleValue();
	}
